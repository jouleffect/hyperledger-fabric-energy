...
cp "${DIR}/../test-network/organizations/peerOrganizations/org1.example.com/connection-org1.yaml" "${DIR}/organization/produttore/gateway/"
cp "${DIR}/../test-network/organizations/peerOrganizations/org2.example.com/connection-org2.yaml" "${DIR}/organization/consumatore/gateway/"
...
echo "./organization/consumatore/configuration/cli/monitordocker.sh fabric_test"
